...
2. Calculate the t-statistics manually (i.e., using a calculator or direct math in R and not just summary): 𝑡=𝛽̂𝑆𝐸(𝛽)

3. Compute p-values for both sets of standard errors. 

4. At 𝛼 = 0.05, would you reject the null hypothesis for each coefficient in both models?
